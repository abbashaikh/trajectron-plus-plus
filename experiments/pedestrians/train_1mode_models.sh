...
# Ours
torchrun --nproc_per_node=1 --master_port=29500 ../../train_unified.py --eval_every=1 --vis_every=1 --batch_size=256 --eval_batch_size=256 --preprocess_workers=16 --log_dir=kf_models --log_tag=eth_1mode_adaptive_tpp --train_epochs=5 --conf=../../config/pedestrians.json --trajdata_cache_dir=~/.unified_data_cache --data_loc_dict=\{\"eupeds_eth\":\ \"~/Projects/RobotSocialNavigation/datasets/eth_ucy_peds\"\} --train_data=eupeds_eth-train --eval_data=eupeds_eth-val --history_sec=2.8 --prediction_sec=4.8 --K=1 --adaptive=True --alpha_init=0.00043 --augment_input_noise=0.005 --grad_clip=5.37 --learning_rate=0.00038 --sigma_eps_init=0.293

# K0
torchrun --nproc_per_node=1 --master_port=29500 ../../train_unified.py --eval_every=1 --vis_every=1 --batch_size=256 --eval_batch_size=256 --preprocess_workers=16 --log_dir=kf_models --log_tag=eth_1mode_k0_tpp --train_epochs=5 --conf=../../config/pedestrians.json --trajdata_cache_dir=~/.unified_data_cache --data_loc_dict=\{\"eupeds_eth\":\ \"~/Projects/RobotSocialNavigation/datasets/eth_ucy_peds\"\} --train_data=eupeds_eth-train --eval_data=eupeds_eth-val --history_sec=2.8 --prediction_sec=4.8 --K=1 --adaptive=True --only_k0=True --alpha_init=2.97e-05 --augment_input_noise=0.86 --grad_clip=87.66 --learning_rate=0.0023 --sigma_eps_init=0.476

# Base
torchrun --nproc_per_node=1 --master_port=29500 ../../train_unified.py --eval_every=1 --vis_every=1 --batch_size=256 --eval_batch_size=256 --preprocess_workers=16 --log_dir=kf_models --log_tag=eth_1mode_base_tpp --train_epochs=5 --conf=../../config/pedestrians.json --trajdata_cache_dir=~/.unified_data_cache --data_loc_dict=\{\"eupeds_eth\":\ \"~/Projects/RobotSocialNavigation/datasets/eth_ucy_peds\"\} --train_data=eupeds_eth-train --eval_data=eupeds_eth-val --history_sec=2.8 --prediction_sec=4.8 --K=1 --alpha_init=1.54e-05 --augment_input_noise=0.57 --grad_clip=0.909 --learning_rate=0.016 --sigma_eps_init=0.0002
